 ...
 * @author dinhgiang1
 */
public class Menu_TaiKhoan extends javax.swing.JInternalFrame {
    String TAIKHOAN = "";
    ...
    public void load_db() {
        try {
            conn = cn.gConnection();
            DefaultTableModel model = new DefaultTableModel(new String[]{"TÀI KHOẢN", "ROLE", "MÃ LỚP"}, 0) {
                @Override
            ...
            while(rs.next()) {
                ...
                model.addRow(new Object[] {TAIKHOAN, ROLE, MALOP});
            }
    ...
    private void initComponents() {
        ...
        btntaolophoc.setText("Sửa thông tin");
