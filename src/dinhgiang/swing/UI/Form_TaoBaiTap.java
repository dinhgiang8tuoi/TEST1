 ...
 * @author dinhgiang1
 */
public class Form_TaoBaiTap extends javax.swing.JFrame {
     ...
     */
    public Form_TaoBaiTap() {
        initComponents();
        FLAGDEFAULT();
        load_cb();
    }
    public Form_TaoBaiTap(int FLAG, String MABT) {
        initComponents();
        this.FLAG = FLAG;
        this.MABT = MABT;
    ...
    public void load_db0() {
        try {
            ...
            String MALOP = "";
            conn = cn.gConnection();
            String query = "SELECT * FROM BAITAP WHERE MABT = '"+MABT+"'";
            Statement stm = conn.createStatement();
            ResultSet rs = stm.executeQuery(query);
            
            if (rs.next()) {
                ANH = rs.getString("ANH");
                MABT1 = rs.getString("MABT");
                TENBT = rs.getString("TENBT");
                SODIEM = Double.parseDouble(rs.getString("SODIEM"));
                MALOP = rs.getString("MALOP");
            }
            IMGPATH = ANH;
            tfmabt.setText(MABT1);
            tftenbaitap.setText(TENBT);
            cbmalop.setSelectedItem(MALOP);
            tfsodiem.setText(String.valueOf(SODIEM));
    ...
    public void FLAG1 () {
        ...
        lbheading.setText("SỬA THÔNG TIN BÀI TẬP");
    ...
    private void initComponents() {
        ...
        tftenbaitap = new javax.swing.JTextField();
        jLabel7 = new javax.swing.JLabel();
        cbmalop = new javax.swing.JComboBox<>();
        lbsodiem = new javax.swing.JLabel();
        tfsodiem = new javax.swing.JTextField();
        ...
        tftenbaitap.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N

        jLabel7.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        jLabel7.setText("Tên bài tập");
        ...
        lbsodiem.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        lbsodiem.setText("Điểm");

        tfsodiem.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(tfmabt, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
                            .addComponent(jLabel8, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel7, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tftenbaitap, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
                            .addComponent(cbmalop, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(lbsodiem, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tfsodiem, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(101, 101, 101))))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tfmabt, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tftenbaitap, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(lbsodiem)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tfsodiem, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnthemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemActionPerformed
        ...
        try {
            conn = cn.gConnection();
            Statement stm = conn.createStatement();
            String queryCheck = "SELECT MABT FROM BAITAP WHERE MABT = '"+MABT+"'";
            ResultSet rs = stm.executeQuery(queryCheck);
            if (rs.next()) {
                JOptionPane.showMessageDialog(this, "Mã bài tập đã tồn tại. Vui lòng nhập mã khác");
                return;
            }
...
// THêm test1
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_TaoBaiTap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_TaoBaiTap().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField tfsodiem;
    private javax.swing.JTextField tftenbaitap;
